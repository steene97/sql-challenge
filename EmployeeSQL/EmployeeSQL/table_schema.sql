...
CREATE TABLE "dept_manager" (
    ...
    CONSTRAINT "pk_dept_emp_man" PRIMARY KEY (
        "emp_no","dept_no"
     )
);
...
ALTER TABLE "dept_manager" ADD CONSTRAINT "fk_dept_man_emp_no" FOREIGN KEY("emp_no")
REFERENCES "employees" ("emp_no");

ALTER TABLE "dept_manager" ADD CONSTRAINT "fk_dept_man_dept_no" FOREIGN KEY("dept_no")
REFERENCES "departments" ("dept_no");
